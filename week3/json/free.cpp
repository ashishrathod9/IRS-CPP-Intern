...
public:
    ...
    friend void to_json(json &j, const ConfigClass &c);
    friend void from_json(const json &j, ConfigClass &c);
};


     void to_json(json &j, const ConfigClass &c) {
            j = json{
                {"host", c.host},
                {"port", c.port},
                {"username", c.username},
         ...
         void from_json(const json &j, ConfigClass &c) {
...
struct ConfigStruct {
 ...
 void to_json(json &j, const ConfigStruct &c) {
            j = json{
                {"host", c.host},
                {"port", c.port},
                {"username", c.username},
         ...
         void from_json(const json &j, ConfigStruct &c) {
            c.host = j.at("host").get<string>();
            c.port = j.at("port").get<int>();
            c.username = j.at("username").get<string>();
            c.password = j.at("password").get<string>();
